...
?>  
   <br>
    <div class="container-fluid remove-vid-marg py-4">
      <div class="vid-parent">
        <img src="elearning-getty.jpg" alt="" width="100%" height="600px">
      <div class="vid-content" >
        <h1 class="my-content" style="color: black;">Portal to learn engineering in kannada</h1>
              ...
              echo '
                <a href="coursedetails.php?course_id='.$course_id.'"  class="btn" style="text-align: left; padding:0px;">
                  <div class="card">
                    ...
                    <div class="card-footer">
                      <p class="card-text d-inline"></p> <a class="btn btn-primary text-white font-weight-bolder float-right" href="#">Enroll</a>
                    </div>
                  </div>
                </a>  ';
            }
